...
<input type="hidden" name="table1" id="table" class="form-control" value="<?php echo $table; ?>" />
<input type="hidden" class="form-control" placeholder='Product Name' name="common_name" id="common_name">
...
<div class='top-bar'>
    ...
    <button class="add-action" id='add-action' style="display:none;">add</button>
...
$num = mysqli_num_rows($result);
    ...
    <td style='width:25%;height:auto;'><?php echo $common_name;?></td>
    <td style='width:25%;height:auto;'><?php echo $brands;?></td>
...
<button type="submit"  class="btn btn-light pagination-first"  style='margin-left:10px;display:flex;align-items: center;' id="1">
<span class="material-symbols-outlined">skip_previous</span> FIRST
                              </button>
...
<span class="material-symbols-outlined">skip_previous</span>PERVIOUS
                              </button>

<button type="submit"  class="btn btn-light pagination-last"  style='margin-left:10px;display:flex;align-items: center;'  id="<?php echo $totalpage; ?>">
                             LAST<span class="material-symbols-outlined">skip_next</span>
                              </button>
                            </diV>
<?php }else{
